...
/**
 * Unit tests for Course and Student.
 *
 * @author Agatha Owora
 */
class LabTest {
     ...
     * To be disabled after it has been passed on step 6 of the lab instructions.
     * Use @Disabled right above the @Test to achieve this.
     */
    @Disabled
    @Test
    void testStudentID() {
